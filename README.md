...
4. Структура HTML-дайджеста — 5 тематических секций с emoji-заголовками:
   ...
   - 🏢 **Упоминания компаний** — посты без чёткой категории, но с упоминанием Роснефть/Лукойл/Газпром (orphans). Пост в категории с mentions получает inline-маркер `[РОСНЕФТЬ]`/`[ЛУКОЙЛ]`/`[ГАЗПРОМ]` перед summary.
