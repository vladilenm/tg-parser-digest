...
**Plans**: 4 plans
- [ ] 03-01-PLAN.md — Foundation (cheerio dep + websites.json seed + WebsitesFileSchema + WebRunSummary + writeRawWeb/writeOutputWeb)
- [ ] 03-02-PLAN.md — src/web-scraper.ts (loadWebsites + fetchSite + extractText + siteToPost + runWebPipeline)
- [ ] 03-03-PLAN.md — Daemon integration (refactor pipeline.ts/run.ts + logWebRunSummary; D-06..D-09 alert stage="web")
- [ ] 03-04-PLAN.md — Vitest unit tests + README «Парсинг веб-сайтов»
**UI hint**: no
